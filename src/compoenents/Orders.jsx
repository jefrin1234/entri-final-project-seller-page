...
//       ) : (
//         orders.map(order => (
//           <div key={order._id + 1} className="bg-white shadow-md rounded-lg p-4 mb-4">
//             <h2 className="text-xl font-semibold">Order ID: {order._id}</h2>
//             <p className="text-gray-700">Total Price: <span className="font-bold">${order.totalPrice}</span></p>
...
//                 <div key={item.productId._id} className="border p-2 mb-2 rounded bg-gray-100">
